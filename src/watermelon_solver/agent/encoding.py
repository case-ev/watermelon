...
class ActionDecoder:
    ...
    def __call__(self, word: Iterable[bool]) -> Iterable[Tuple[wm.Vertex, wm.VertexAction]]:
        return self.decode(word)

    def decode(self, word: Iterable[bool]) -> Iterable[Tuple[wm.Vertex, wm.VertexAction]]:
